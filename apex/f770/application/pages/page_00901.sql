...
,p_last_upd_yyyymmddhh24miss=>'20220206121217'
);
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(23155108968829514)
,p_name=>'PAGE_TITLE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(23202203325930432)
,p_view_id=>wwv_flow_api.id(10444067309249321)
,p_display_seq=>14
,p_column_id=>wwv_flow_api.id(23155108968829514)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(21746924778497834)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21746836282497833)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23306067035761016)
