CREATE OR REPLACE TRIGGER translations__
FOR UPDATE OR INSERT OR DELETE ON translations
COMPOUND TRIGGER

    in_table_name           CONSTANT user_tables.table_name%TYPE := 'TRANSLATIONS';
    --
    curr_log_id             logs.log_id%TYPE;
    curr_updated_by         translations.updated_by%TYPE;
    curr_updated_at         translations.updated_at%TYPE;
    --
