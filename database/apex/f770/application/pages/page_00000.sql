...
,p_last_upd_yyyymmddhh24miss=>'20220318112730'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16222516003514114)
,p_plug_name=>'DEV'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16222425620514113)
,p_plug_name=>'Debug for Developers'
,p_parent_plug_id=>wwv_flow_imp.id(16222516003514114)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24355119683954725)
,p_plug_name=>'TABS'
,p_parent_plug_id=>wwv_flow_imp.id(16222516003514114)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24355248073954726)
,p_plug_name=>'Page Items'
,p_parent_plug_id=>wwv_flow_imp.id(24355119683954725)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(9049155795569902)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(16221637563514105)
,p_name=>'Page Items [DATA]'
,p_parent_plug_id=>wwv_flow_imp.id(24355248073954726)
,p_template=>wwv_flow_imp.id(9078290074569925)
,p_display_sequence=>20
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-AVPList--fixedLabelLarge:t-AVPList--leftAligned:t-Report--hideNoPagination'
,p_region_attributes=>'style="overflow-x: hidden; overflow-wrap: break-word;"'
...
,p_query_row_template=>wwv_flow_imp.id(9115257435569961)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(16221782509514106)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(16221810155514107)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16470181577696749)
,p_plug_name=>'Page Items'
,p_parent_plug_id=>wwv_flow_imp.id(24355248073954726)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24355358988954727)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(16222122706514110)
,p_name=>'App/Global Items [DATA]'
,p_parent_plug_id=>wwv_flow_imp.id(24355358988954727)
,p_template=>wwv_flow_imp.id(9078290074569925)
,p_display_sequence=>20
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-AVPList--fixedLabelLarge:t-AVPList--leftAligned:t-Report--hideNoPagination'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(16222241084514111)
,p_query_column_id=>1
,p_column_alias=>'ITEM_NAME'
,p_column_display_sequence=>10
,p_column_heading=>'Item Name'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(16222360232514112)
,p_query_column_id=>2
,p_column_alias=>'ITEM_VALUE'
,p_column_display_sequence=>20
,p_column_heading=>'Item Value'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16470239693696750)
,p_plug_name=>'App/Global Items'
,p_parent_plug_id=>wwv_flow_imp.id(24355358988954727)
,p_region_template_options=>'#DEFAULT#:t-HeroRegion--hideIcon'
,p_region_attributes=>'style="margin-top: -1rem;"'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24355504797954729)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17062142630582707)
,p_plug_name=>'SYS_CONTEXT'
,p_parent_plug_id=>wwv_flow_imp.id(24355504797954729)
,p_region_template_options=>'#DEFAULT#:t-HeroRegion--hideIcon'
,p_region_attributes=>'style="margin-top: -1rem;"'
,p_plug_template=>wwv_flow_imp.id(9070356145569920)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(17062213215582708)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17062566806582711)
,p_query_column_id=>1
,p_column_alias=>'NAME'
,p_column_display_sequence=>10
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17062636115582712)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24355779690954731)
,p_plug_name=>'NLS'
,p_parent_plug_id=>wwv_flow_imp.id(24355119683954725)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(9049155795569902)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17063289732582718)
,p_plug_name=>'NLS'
,p_parent_plug_id=>wwv_flow_imp.id(24355779690954731)
,p_region_template_options=>'#DEFAULT#:t-HeroRegion--hideIcon'
,p_region_attributes=>'style="margin-top: -1rem;"'
,p_plug_template=>wwv_flow_imp.id(9070356145569920)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(17063357118582719)
,p_name=>'NLS [DATA]'
,p_parent_plug_id=>wwv_flow_imp.id(24355779690954731)
,p_template=>wwv_flow_imp.id(9078290074569925)
,p_display_sequence=>20
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17063972173582725)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17063536602582721)
,p_query_column_id=>2
,p_column_alias=>'VALUE'
,p_column_display_sequence=>20
,p_column_heading=>'Value'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24355859067954732)
,p_plug_name=>'USERENV'
,p_parent_plug_id=>wwv_flow_imp.id(24355119683954725)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(9049155795569902)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17063109437582717)
,p_plug_name=>'USERENV'
,p_parent_plug_id=>wwv_flow_imp.id(24355859067954732)
,p_region_template_options=>'#DEFAULT#:t-HeroRegion--hideIcon'
,p_region_attributes=>'style="margin-top: -1rem;"'
,p_plug_template=>wwv_flow_imp.id(9070356145569920)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(17063670953582722)
,p_name=>'USERENV [DATA]'
,p_parent_plug_id=>wwv_flow_imp.id(24355859067954732)
,p_template=>wwv_flow_imp.id(9078290074569925)
,p_display_sequence=>20
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17063733186582723)
,p_query_column_id=>1
,p_column_alias=>'NAME'
,p_column_display_sequence=>10
,p_column_heading=>'Name'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17063809834582724)
,p_query_column_id=>2
,p_column_alias=>'VALUE'
,p_column_display_sequence=>20
,p_column_heading=>'Value'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24355948164954733)
,p_plug_name=>'CGI'
,p_parent_plug_id=>wwv_flow_imp.id(24355119683954725)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(9049155795569902)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17062776241582713)
,p_plug_name=>'CGI'
,p_parent_plug_id=>wwv_flow_imp.id(24355948164954733)
,p_region_template_options=>'#DEFAULT#:t-HeroRegion--hideIcon'
,p_region_attributes=>'style="margin-top: -1rem;"'
,p_plug_template=>wwv_flow_imp.id(9070356145569920)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(17062881718582714)
,p_name=>'CGI [DATA]'
,p_parent_plug_id=>wwv_flow_imp.id(24355948164954733)
,p_template=>wwv_flow_imp.id(9078290074569925)
,p_display_sequence=>20
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17062953302582715)
,p_query_column_id=>1
,p_column_alias=>'NAME'
,p_column_display_sequence=>10
,p_column_heading=>'Name'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17063041292582716)
,p_query_column_id=>2
,p_column_alias=>'VALUE'
,p_column_display_sequence=>20
,p_column_heading=>'Value'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24356060019954734)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24356142145954735)
,p_plug_name=>'Page Items'
,p_parent_plug_id=>wwv_flow_imp.id(24356060019954734)
,p_region_template_options=>'#DEFAULT#:t-HeroRegion--hideIcon'
,p_region_attributes=>'style="margin-top: -1rem;"'
,p_plug_template=>wwv_flow_imp.id(9070356145569920)
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(24356246417954736)
,p_name=>'Page Items [DATA]'
,p_parent_plug_id=>wwv_flow_imp.id(24356060019954734)
,p_template=>wwv_flow_imp.id(9078290074569925)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(24356316524954737)
,p_query_column_id=>1
,p_column_alias=>'ITEM_NAME'
,p_column_display_sequence=>10
,p_column_heading=>'Item Name'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(24356402280954738)
,p_query_column_id=>2
,p_column_alias=>'ITEM_VALUE'
,p_column_display_sequence=>20
,p_column_heading=>'Item Value'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(25346957705653212)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(25347091934653213)
,p_plug_name=>'Page Translations'
,p_parent_plug_id=>wwv_flow_imp.id(25346957705653212)
,p_region_template_options=>'#DEFAULT#:t-HeroRegion--hideIcon'
,p_region_attributes=>'style="margin-top: -1rem;"'
,p_plug_template=>wwv_flow_imp.id(9070356145569920)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(25347235768653215)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(25347377654653216)
,p_query_column_id=>1
,p_column_alias=>'ITEM_NAME'
,p_column_display_sequence=>10
,p_column_heading=>'Item Name'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(25347420785653217)
,p_query_column_id=>2
,p_column_alias=>'ITEM_VALUE'
,p_column_display_sequence=>20
,p_column_heading=>'Item Value'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(23726400898559213)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16470096407696748)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(16222425620514113)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17061889596582704)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(32963396475841108)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17061664291582702)
,p_name=>'P0_REQUEST_LOG'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(16222425620514113)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17061957126582705)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23726556527559214)
,p_name=>'P0_MESSAGE_ERROR'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(23726400898559213)
,p_prompt=>'Error'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23726687796559215)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23726720709559216)
,p_name=>'P0_MESSAGE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(23726400898559213)
,p_prompt=>'Message'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23726824905559217)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23726986494559218)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(32963417241841109)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(11425112951377811)
,p_name=>'ON_LOAD'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(11425241361377812)
,p_event_id=>wwv_flow_imp.id(11425112951377811)
,p_event_result=>'TRUE'
