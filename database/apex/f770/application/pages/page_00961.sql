...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(16026214981727247)
...
,p_query_row_template=>wwv_flow_imp.id(9103852041569949)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(32965001043841125)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(16026326961727248)
,p_query_column_id=>2
,p_column_alias=>'NAME'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(16026485211727249)
,p_query_column_id=>3
,p_column_alias=>'TYPE'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(16026593816727250)
,p_query_column_id=>4
,p_column_alias=>'LINE'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(16221294148514101)
,p_query_column_id=>5
,p_column_alias=>'TEXT'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(16221307374514102)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(16226090811514149)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(32964662504841121)
,p_query_column_id=>1
,p_column_alias=>'OWNER'
,p_column_display_sequence=>50
,p_use_as_row_header=>'N'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(16226177939514150)
,p_query_column_id=>2
,p_column_alias=>'NAME'
,p_column_display_sequence=>10
,p_use_as_row_header=>'N'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(16465470495696702)
,p_query_column_id=>3
,p_column_alias=>'LINE'
,p_column_display_sequence=>30
,p_column_heading=>'Line'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(16465549614696703)
,p_query_column_id=>4
,p_column_alias=>'TEXT'
,p_column_display_sequence=>40
,p_column_heading=>'Text'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(22083969826580607)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(32965134513841126)
,p_query_column_id=>1
,p_column_alias=>'OWNER'
,p_column_display_sequence=>60
,p_use_as_row_header=>'N'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(22084065592580608)
,p_query_column_id=>2
,p_column_alias=>'NAME'
,p_column_display_sequence=>10
,p_use_as_row_header=>'N'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(22084120662580609)
,p_query_column_id=>3
,p_column_alias=>'TYPE'
,p_column_display_sequence=>20
,p_use_as_row_header=>'N'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(22084247482580610)
,p_query_column_id=>4
,p_column_alias=>'LINE'
,p_column_display_sequence=>30
,p_column_heading=>'Line'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(22084317038580611)
,p_query_column_id=>5
,p_column_alias=>'TEXT'
,p_column_display_sequence=>40
,p_column_heading=>'Text'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(22084452881580612)
,p_query_column_id=>6
,p_column_alias=>'ORIGIN_CON_ID'
,p_column_display_sequence=>50
,p_use_as_row_header=>'N'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(21541647525954410)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(16023674651727221)
,p_button_name=>'GENERATE_CALLER'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#:t-Button--iconLeft'
,p_button_template_id=>wwv_flow_imp.id(9145303400569999)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(21542011440954414)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(21541592953954409)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16023824951727223)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16023953626727224)
,p_name=>'P961_MODULE_NAME'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(16023674651727221)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16024006234727225)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16024150723727226)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16024200790727227)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16225903886514148)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(21541724678954411)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(21541867459954412)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(21542290793954416)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(21542719121954421)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(21543509717954429)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22083657862580604)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22083700749580605)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(16024413800727229)
,p_name=>'CLOSE_MODAL'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(16023824951727223)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16225825315514147)
,p_event_id=>wwv_flow_imp.id(16024413800727229)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16024512776727230)
,p_event_id=>wwv_flow_imp.id(16024413800727229)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(21542324823954417)
,p_name=>'COPY_SOURCE'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(21541592953954409)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(21542460104954418)
,p_event_id=>wwv_flow_imp.id(21542324823954417)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(21542877758954422)
,p_name=>'COPY_CALLER'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(21541647525954410)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
,p_display_when_type=>'ITEM_IS_NOT_NULL'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(21543075155954424)
,p_event_id=>wwv_flow_imp.id(21542877758954422)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(21543671795954430)
,p_name=>'COPY_HANDLER'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(21542011440954414)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
,p_display_when_type=>'ITEM_IS_NOT_NULL'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(21543713456954431)
,p_event_id=>wwv_flow_imp.id(21543671795954430)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(21541979804954413)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(21543382621954427)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(22083808290580606)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(21543226420954426)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(21542612419954420)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(21543405772954428)
