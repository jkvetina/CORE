...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(20451776483336220)
,p_install_id=>wwv_flow_api.id(12958699824624058)
,p_name=>'INSTALL_PACKAGES'
,p_sequence=>40
...
'            REGEXP_REPLACE(',
'                NULLIF(JSON_ARRAY(in_arg1, in_arg2, in_arg'))
);
null;
wwv_flow_api.component_end;
end;
...
wwv_flow_api.append_to_install_script(
 p_id=>wwv_flow_api.id(20451776483336220)
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'3, in_arg4, in_arg5, in_arg6, in_arg7, in_arg8 NULL ON NULL), ''[]''),',
...
'',
'    -- for sending emails',
unistr('    smtp_from                   CONSTANT VARCHAR2(200)      := ''Jan Kv\011Btina <jan.kvetina@gmail.com>'';'),
'    smtp_username               CONSTANT VARCHAR2(50)       := NULL;',
'    smtp_password               CONSTANT VARCHAR2(50)       := NULL;',
'    smtp_host                   CONSTANT VARCHAR2(50)       := ''smtp.email.eu-frankfurt-1.oci.oraclecloud.com'';',
...
wwv_flow_api.append_to_install_script(
 p_id=>wwv_flow_api.id(20451776483336220)
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'r.arg = ''C013'' THEN r.context_id       WHEN r.arg = ''C014'' THEN r.context_id',
...
'        -- @TODO: MULTIPLE APPS !!!',
'        --',
'        -- merge all apps/settings (in same schema) into 1 sett package',
'        -- use get_setting_name_DATATYPE ??? for dates, numbers',
'        -- resolve app inside for current application',
'        --',
'        FOR c IN (',
'            SELECT',
'                s.setting_name,',
...
wwv_flow_api.create_install_object(
 p_id=>wwv_flow_api.id(20451802002336231)
,p_script_id=>wwv_flow_api.id(20451776483336220)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
,p_object_name=>'A770'
,p_last_updated_by=>'DEV'
,p_last_updated_on=>to_date('20220123180503','YYYYMMDDHH24MISS')
,p_created_by=>'DEV'
,p_created_on=>to_date('20220123180503','YYYYMMDDHH24MISS')
);
wwv_flow_api.create_install_object(
 p_id=>wwv_flow_api.id(20452010246336231)
,p_script_id=>wwv_flow_api.id(20451776483336220)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
,p_object_name=>'APP'
...
wwv_flow_api.create_install_object(
 p_id=>wwv_flow_api.id(20452213537336231)
,p_script_id=>wwv_flow_api.id(20451776483336220)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
,p_object_name=>'APP_ACTIONS'
,p_last_updated_by=>'DEV'
,p_last_updated_on=>to_date('20220123180503','YYYYMMDDHH24MISS')
,p_created_by=>'DEV'
,p_created_on=>to_date('20220123180503','YYYYMMDDHH24MISS')
...
wwv_flow_api.create_install_object(
 p_id=>wwv_flow_api.id(20452449161336231)
,p_script_id=>wwv_flow_api.id(20451776483336220)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PROCEDURE'
,p_object_name=>'RECOMPILE'
,p_last_updated_by=>'DEV'
,p_last_updated_on=>to_date('20220123180503','YYYYMMDDHH24MISS')
,p_created_by=>'DEV'
,p_created_on=>to_date('20220123180503','YYYYMMDDHH24MISS')
